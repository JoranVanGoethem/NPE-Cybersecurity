...
1. **Download de benodigde VDI-bestanden**:
   ...
   ![Sourceforge locatie](./img/img-VMAanmaken/)
...
2. **extract de zip files**
   ...
   ![VDI files locatie](./img/img-VMAanmaken/)
...
4. **Voeg VBoxManage toe aan de terminal**
   ...
   ![bash VboxManage](./img/img-VMAanmaken/)
...
5. **Voer het script `Build-VM.sh` uit.**
   ...
   ![bash script runnen](./img/img-VMAanmaken/)

   ![virtualbox VM's](./img/img-VMAanmaken/)

6. **start de VM's**

   - open virtualbox en start beide VM's

   ![Virtualbox draaiend](./img/img-VMAanmaken/)
...
7. **Controleer of de VM's correct zijn opgestart** via de VirtualBox GUI of via:
   ...
   ![running bash](./img/img-VMAanmaken/)
...
8. **Log in op de VM's**
   ...
   ![VM schermen](./img/img-VMAanmaken/)
